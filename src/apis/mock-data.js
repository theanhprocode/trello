export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TheanhTrelloApp',
    description: 'TrelloApp',
    type: 'public', // 'private'
    ownerIds: [], // users Admin của board
    memberIds: [], // users member bình thường của board
        ...
        cards: [
          {
            ...
            cover: 'https://symbols.vn/wp-content/uploads/2022/01/Hinh-Nen-Songoku-4k-manh-me-nhat.jpg',

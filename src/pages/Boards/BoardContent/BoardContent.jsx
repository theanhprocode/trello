...
function BoardContent({ board, createNewColumn, createNewCard, moveColumns, moveCardInTheSameColumn, moveCardToDifferentColumn, deleteColumnDetails, deleteCardDetails, updateCardTitle }) {
  ...
  // khởi tao funtion cập nhật lại state trong trường hợp di chuyển card giữa các column khác nhau
  ...
  return (
    ...
    >
      <Box sx={{
        ...
        <ListColumns columns={orderedColumns} createNewColumn={createNewColumn} createNewCard={createNewCard} deleteColumnDetails={deleteColumnDetails} deleteCardDetails={deleteCardDetails} updateCardTitle={updateCardTitle} />
